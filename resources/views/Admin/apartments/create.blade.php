    ...
    <div class="container">
        <form method="POST" action="{{ route('admin.apartments.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group col-12  col-md-3">
                ...
                <input type="number" class="form-control @error('n_rooms') is-invalid @enderror" id="n_rooms" name="n_rooms" min="1">
                @error('n_rooms')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            <div class="form-group col-12  col-md-3">
                ...
                <input type="number" class="form-control @error('n_beds') is-invalid @enderror" id="n_beds" name="n_beds" min="1">
                @error('n_beds')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            <div class="form-group col-12  col-md-3">
                ...
                <input type="number" class="form-control @error('n_baths') is-invalid @enderror" id="n_baths" name="n_baths" min="1">
                @error('n_baths')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            <div class="form-group col-12  col-md-3">
                ...
                <input type="number" class="form-control @error('sqrmt') is-invalid @enderror" id="sqrmt" name="sqrmt" min="1">
                @error('sqrmt')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
